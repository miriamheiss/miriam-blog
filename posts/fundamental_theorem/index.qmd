...
```
In this graph, the first "down-up" doesn't technically intersect the x axis, but it's also not floating around elsewhere. This is a **double root**.
...
You can do it by hand with synthetic division. Or you can make your life just a little bit easier and make the computer do it:
