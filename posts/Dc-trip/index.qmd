...
```{r courthouse, echo = FALSE, out.width = 1000}
knitr::include_graphics("appomattox_court_house.jpg")
```

###### Photo:
[Appomattox Courthouse](https://commons.wikimedia.org/wiki/File:Old_Appomattox_Court_House_reconstructed_2.jpg), by [Doug Coldwell](https://commons.wikimedia.org/wiki/User:Doug_Coldwell)
...
###### Photo:
[Tredagar Iron works Museum](https://en.wikipedia.org/wiki/Tredegar_Iron_Works#/media/File:Pattern_building,_Tredegar_Iron_Works,_Richmond,_Virginia.JPG), by [Morgan Riley](https://commons.wikimedia.org/wiki/User:Morgan_Riley)
---
...
[Richmond Canal Walk](https://en.wikipedia.org/wiki/James_River_and_Kanawha_Canal#/media/File:Richmond_Canal_Walk.jpg), by Ben Schumin
...
```{r quantico, echo = FALSE, out.width = 1000}
knitr::include_graphics("Museum_of_the_marines_corps.jpg")
```

###### Photo:

[National Museum of the Marine Corps (Quantico)](https://en.wikipedia.org/wiki/National_Museum_of_the_Marine_Corps#/media/File:Museum_of_the_marines_corps.JPG), by [RadioFan](https://en.wikipedia.org/wiki/User:RadioFan)
...
[Washington Monument (2022)](https://en.wikipedia.org/wiki/Washington_Monument#/media/File:Washington_Monument_2022.jpg), by [Greyfiveys](https://commons.wikimedia.org/wiki/User:Greyfiveys)
...
[The Rotunda in the National Archives Building](https://en.wikipedia.org/wiki/Charters_of_Freedom#/media/File:ArchivesRotunda.jpg)
...
[The Hope Diamond](https://en.wikipedia.org/wiki/Hope_Diamond#/media/File:Hope_Diamond_Closeup.jpg), by [Mbalotia](https://commons.wikimedia.org/wiki/User:Mbalotia)
...
[International Spy Museum 2020](https://en.wikipedia.org/wiki/International_Spy_Museum#/media/File:International_Spy_Museum_2020.jpg), by [Itrytohelp](https://commons.wikimedia.org/w/index.php?title=User:Itrytohelp32&action=edit&redlink=1)
...
###### Photo: 
[Arlington House](https://en.wikipedia.org/wiki/Arlington_National_Cemetery#/media/File:Arlington_House.jpg)
