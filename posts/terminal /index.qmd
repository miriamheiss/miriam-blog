...
date: "2022-08-19"
categories: [tutorial]
image: "photo-1608742213509-815b97c30b36.jpg"
sidebar: true
toc: true
format:
  html:
...
I cannot stress this enough! When you remove a file it is **permanent**. Gone. Never to be seen **ever**. Make sure you remove the right file. 
:::

Be so careful removing files through terminal!!!

We are going to be removing the file `practice2`. I rarely remove things through terminal, as finder is safer, but I know what this file is called and exactly what is in it.
