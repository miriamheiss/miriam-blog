...
The terminal is an interface that lets you access the command line. Essentially it lets you make folders and move things, without touching a mouse. If you can't open Finder or Windows Explorer, you can access files in the terminal. You can access the terminal in RStudio, or in your Applications folder. In Jurassic Park, when Lex Murphy is hacking the computer to get the park running again, she is using a terminal. All computers up until the mid-nineties used terminals, and terminals alone. Unix systems are still used today, now they are called [Linux](https://www.linux.com/what-is-linux/) (Macs are also Linux/Unix systems).

```{r out.width="75%", fig.align="center", echo=FALSE, fig.cap="Blah"}
